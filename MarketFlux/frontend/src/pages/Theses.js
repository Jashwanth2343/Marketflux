      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <Card className="thesis-panel overflow-hidden rounded-[32px] border-white/10">
          <CardContent className="relative p-6 md:p-8 lg:p-10">
            <div className="absolute inset-y-0 right-0 hidden w-1/2 bg-[radial-gradient(circle_at_top_right,rgba(146,152,166,0.18),transparent_42%),radial-gradient(circle_at_bottom,rgba(227,184,95,0.12),transparent_35%)] lg:block" />
